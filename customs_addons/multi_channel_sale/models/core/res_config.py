		...
		res.update(
			{
				...
				'cron_import_partner': self.env.ref('multi_channel_sale.cron_import_partner').id,
				'cron_import_category': self.env.ref('multi_channel_sale.cron_import_category').id,
				'cron_import_product': self.env.ref('multi_channel_sale.cron_import_product').id,
				'cron_import_order': self.env.ref('multi_channel_sale.cron_import_order').id,
				'cron_evaluation': self.env.ref('multi_channel_sale.cron_evaluation').id,
			}
		)
		return res
